...
if os.path.exists("README.md"):
    ...
    # 주소창과 문법을 파괴하는 하단 찌꺼기 문자열 완전히 도려내기
    content = content.split("---%0A")[0]
    content = content.split("---&amp;")[0]
    content = content.split("---&")[0]

    # 차트 URL 및 마크다운 문법 정밀 변환
...
<head>
    ...
    <style>
        body {{ font-family: -apple-system, BlinkMacSystemFont, sans-serif; background-color: #121212; color: #e0e0e0; margin: 0; padding: 16px; }}
        ...
        h1 {{ color: #FC4C02; text-align: center; font-size: 22px; }}
        h2 {{ color: #ffffff; border-bottom: 1px solid #333; padding-bottom: 8px; font-size: 16px; margin-top: 25px; }}
        h3 {{ color: #FC4C02; font-size: 14px; margin-top: 15px; }}
